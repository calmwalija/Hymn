...
object Migration {
  ...
  val MIGRATION_3_4 = object : Migration(3, 4) {
    override fun migrate(database: SupportSQLiteDatabase) {
      database.execSQL("ALTER TABLE lyric ADD `ftsSuggestion` INTEGER NOT NULL DEFAULT 0")
      database.execSQL("ALTER TABLE lyric ADD `forTheService` INTEGER NOT NULL DEFAULT 0")
